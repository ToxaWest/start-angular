...
export const TEMPLATES: TemplatesInterface[] = [
    {
        ...
        template: '<div style="text-align: left;"><img src="/assets/logo.jpg" style="background-color: transparent;">' +
            '</div><div style="text-align: center;"><span style="background-color: transparent;">' +
            '<b>К О М У Н А Л Ь Н Е П І Д П Р И Є М С Т В О</b></span></div><div style="text-align: center;">' +
            '<span style="background-color: transparent;">' +
            '<b>&nbsp;„Ж И Л К О М С Е Р В І С”&nbsp;</b></span></div>' +
            '<div><hr id="null"><div style="text-align: right;">&lt;%= name %&gt;&nbsp;</div>' +
            '<div style="text-align: right;">&lt;%= address %&gt;&nbsp;</div>' +
            '<div><br></div><div style="text-align: center;">' +
            '<b>ВЫМОГА&nbsp;</b></div><div><br></div><div style="text-align: justify;">' +
            '&nbsp; &nbsp; &nbsp;Доводимо до Вашого відома, що по Вашому особовому ' +
            'рахунку №&lt;%= number %&gt;&nbsp;станом на &lt;%= todayDate %&gt;року\n' +
            'виникла заборгованість перед КП «Жилкомсервіс» в сумі &lt;%= debt %&gt;грн.&nbsp;' +
            '</div><div style="text-align: justify;">&nbsp; &nbsp; &nbsp;' +
            'У зв\'язку з наявністю у Вас\n' +
            ...
            'заборгованість перед КП&nbsp;«Жилкомсервіс» протягом 7&nbsp;днів з моменту отримання даного повідомлення ' +
            'та надати копії     \n' +
